...
/// Hardcoded serde_json "Response" from telegram bot api. We can't genearate
/// this so declare it here
...
/// Error type containing either a Response type from telegram api or a generic
/// error
#[derive(Debug)]
