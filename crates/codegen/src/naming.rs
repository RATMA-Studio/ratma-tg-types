...
/// Reserved words in rust as of 2022. Used to avoid generating identifiers that
/// clash with keywords
...
/// Sanitize an identifier to conform to rust style and avoid using reserved
/// words
...
/// Sanitize a field name to conform to rust style and avoid using reserved
/// words
...
/// Santize an method name to conform to rust style and avoid using reserved
/// words
